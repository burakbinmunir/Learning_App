...
public class MathsEcatTest extends AppCompatActivity implements MCQDataCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maths_ecat_test);
        ...
        firebaseUtils.getEcatTestMcqs("maths",this);
    }
    ...
    private void initializeViews() {
        ...
        btnFinish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MathsEcatTest.this, ApptitudeTestScore.class);
        ...
        countDownTimer =  new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(MathsEcatTest.this, "Time is up", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MathsEcatTest.this, ApptitudeTestScore.class);
                intent.putExtra("score", score);
                startActivity(intent);
            }
