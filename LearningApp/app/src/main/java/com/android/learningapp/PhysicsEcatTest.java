...
public class PhysicsEcatTest extends AppCompatActivity implements MCQDataCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physcis_ecat_test);
        ...
        firebaseUtils.getEcatTestMcqs("physcis",this);
    }
